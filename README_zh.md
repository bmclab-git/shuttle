...
{
  "name": "Shuttle",
  "github-link": "https://github.com/bmclab-git/shuttle",
  "data": "response mock"
}
```
...
### 从源码编译
```sh
go get -d github.com/bmclab-git/shuttle
cd $GOPATH/src/github.com/bmclab-git/shuttle/assets
go generate # 打包HTML和GeoLite2-Country.mmdb到assets/assets.go文件
cd $GOPATH/src/github.com/bmclab-git/shuttle/cmd
